...
export class PageDevolucionesComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.formulario = this.fb.group({
            ...
            rut: [this.rut, [Validators.required, Validators.maxLength(10), rutValidator]],
    ...
    enviar() {
        ...
        this.cargando = true;
        this.clientsService.setDevolucion(this.formulario.value).subscribe((resp: ResponseApi) => {
            if (resp.error) {
            ...
            this.modalService.show(DevolucionOkModalComponent, { class: 'mx-auto modal-devoluciones', ignoreBackdropClick: true });
        });
    }
}
