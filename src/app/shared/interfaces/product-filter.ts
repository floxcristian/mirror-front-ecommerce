...
export type ProductFilter = ProductFilterCategory | ProductFilterPrice | ProductFilterCheckbox | ProductFilterCheckboxFlota | ProductFilterRadio | ProductFilterColor;
