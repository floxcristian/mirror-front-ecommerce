...
@Component({
  ...
  templateUrl: './input-number-product.component.html',
  styleUrls: ['./input-number-product.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => InputNumberProductComponent),
      multi: true,
    },
  ],
})
export class InputNumberProductComponent implements ControlValueAccessor {
  options: any = {
    step: 1,
    min: null,
    max: null,
