    ...
    <div class="pswp__scroll-wrap">
        ...
        <div class="pswp__ui pswp__ui--hidden">
            <div class="pswp__top-bar">
                ...
                <button name="esc" class="pswp__button pswp__button--close" title="Close (Esc)"></button>
                <!--<button name="shared" class="pswp__button pswp__button&#45;&#45;share" title="Share"></button>-->
                <button name="toggle" class="pswp__button pswp__button--fs" title="Toggle fullscreen"></button>
                <button name="zoom" class="pswp__button pswp__button--zoom" title="Zoom in/out"></button>
            ...
            <button name="left" class="pswp__button pswp__button--arrow--left" title="Previous (arrow left)"></button>
            <button name="right" class="pswp__button pswp__button--arrow--right" title="Next (arrow right)"></button>
