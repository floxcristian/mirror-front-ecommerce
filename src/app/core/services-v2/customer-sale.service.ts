...
export class CustomerSaleService {
  ...
  getSales(params: { search: string; page: number; limit: number }): Observable<IPaginated<IOrders>> {
    return this.http.get<IPaginated<IOrders>>(`${API_CUSTOMER_SALE}/sales`, { params: params });
  }
}
