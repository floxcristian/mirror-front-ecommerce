...
import { ICustomerCredit, ICustomerPriceListResponse } from '@core/models-v2/customer/customer.interface';
// Environment
...
export class CustomerService {
  ...
  getCustomerPriceList(documentId:string,params:{
    branchCode:string;
    page:number;
    limit:number;
    search?:string;
    ...
    return this.http.get<ICustomerPriceListResponse>(`${API_CUSTOMER}/${documentId}/price-list`,{params})
  }
