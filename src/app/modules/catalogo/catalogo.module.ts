...
import { PageCatalogoTvComponent } from './pages/page-catalogo-tv/page-catalogo-tv.component';
...
@NgModule({
  declarations: [
    ...
    PageCatalogoTvComponent,
    ProductosCatalogTvComponent,
    PageEsperaCdComponent,
    PagePimTemplateS,
    PagePimTemplateM,
    PagePimTemplateL,
    PagePimTemplateXL,
    ...
    PageCatalogoTvDinamicComponent,
