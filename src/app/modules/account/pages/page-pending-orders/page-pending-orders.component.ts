...
export class PagePendingOrdersComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        if (!this.usuario.hasOwnProperty("username")) this.usuario.username = this.usuario.email;
    }

    loadData() {
        const that = this;
        const columns = ['modificacion', 'estado', 'numero', 'totalOv', 'folio', 'montoOcCliente', 'usuario'];
        ...
        this.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                ...
                dataTablesParameters.sortColumn = columns[dataTablesParameters.order[0].column];
