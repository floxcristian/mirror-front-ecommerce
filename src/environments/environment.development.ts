export const environment = {
  ...
  IVA: 0.19,
  apiConversion:
    'https://graph.facebook.com/v12.0/362035215114882/events?access_token=',
  ...
  apiMobile: 'https://b2b-api.implementos.cl/api/mobile/',
  ...
  apiImplementosBuscador: 'http://api.implementos.cl:8280/api/',
  apiImplementosLogistica: 'https://b2b-api.implementos.cl/api/logistica/',
  urlFotoOmnichannel:
    'http://replicacion.implementos.cl/siteomnichannel/fotos/',
  urlFotoFichaProducto:
    'https://firebasestorage.googleapis.com/v0/b/imagenimplementos.appspot.com/o/FICHA%2F',
  urlFotosVentasArica:
    'http://ventasarica.implementos.cl/omnichannel/Capa_Presentacion/getImagenax.ashx?codFotografia=',
  urlFotoListadoProductos:
    'https://firebasestorage.googleapis.com/v0/b/imagenimplementos.appspot.com/o/450%2F',
  urlFotowidgetProductos:
    'https://firebasestorage.googleapis.com/v0/b/imagenimplementos.appspot.com/o/150%2F',
  sucursalFija: 'CONCEPCION',
  ...
  urlApiChilexpress: 'https://services.wschilexpress.com/',
  urlScreen: 'https://b2b-api.implementos.cl/api/screen/',
  apiPropaganda: 'https://b2b-api.implementos.cl/api/propagandaTV/',
